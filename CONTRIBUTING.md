...
- Copy the file `vss-extensions-dev.json.template` into `vss-extensions-dev.json` file with the new publisher that you setup. Also update the name and id fields.
